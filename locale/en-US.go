...
var en_US = Lang{
	...
	"EndOfSession.Title":   "End Of Sessio Handler",
	"EndOFSession.Message": "Alexa Skill Default Session Ended Handler. Good bye.",

	"Handler.Title":   "Default Handler",
	"Handler.Message": "Alexa Skill Default Handler For ",
}
