...
func NewTemplateBuilder(templatetype string) TemplateBuilder {
	switch templatetype {
	case "BodyTemplate1":
		return &BodyTemplate1{TemplateCommon: TemplateCommon{Type: templatetype}}
	case "BodyTemplate2":
		return &BodyTemplate2{TemplateCommon: TemplateCommon{Type: templatetype}}
	case "BodyTemplate3":
		return &BodyTemplate3{TemplateCommon: TemplateCommon{Type: templatetype}}
	case "BodyTemplate6":
		return &BodyTemplate6{TemplateCommon: TemplateCommon{Type: templatetype}}
	case "BodyTemplate7":
		return &BodyTemplate7{TemplateCommon: TemplateCommon{Type: templatetype}}
	case "ListTemplate1":
		return &ListTemplate1{TemplateCommon: TemplateCommon{Type: templatetype}}
	case "ListTemplate2":
		return &ListTemplate2{TemplateCommon: TemplateCommon{Type: templatetype}}
	}
	return nil
}
...
func (builder *BodyTemplate1) WithBackgroundImage(image string) *DisplayImage {
	builder.BackgroundImage = &DisplayImage{Sources: &[]ImageSource{{URL: image}}}
...
func (builder *BodyTemplate2) WithImage(image string) *DisplayImage {
	builder.Image = &DisplayImage{Sources: &[]ImageSource{{URL: image}}}
...
func (builder *ListTemplate1) AddListItem(token string, image string, text string) *ListItem {
	item := &ListItem{
		Token:       token,
		Image:       &DisplayImage{Sources: &[]ImageSource{{URL: image}}},
